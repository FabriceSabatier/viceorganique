...
var CONSTANTS = {
  ...
  MEMBRANE: {
    ...
    DECALTEXT: 50, //décalage en hauteur du texte pour qu'il y en ait un plus haut que l'autre

    UPDECALTEXT: -60, //peut-être pour empêcher les labels de sortir en haut et en bas (marges)
...
CONSTANTS.MEMBRANE.TEXTdx = -0.1*CONSTANTS.VUE.WIDTH;

CONSTANTS.MEMBRANE.TEXTdy = 0.005*CONSTANTS.VUE.HEIGHT;
