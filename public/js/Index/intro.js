...
CONST.FICHE = {};
function coefSize(){
  if (CONST.VUE.WIDTH/CONST.VUE.HEIGHT<1){
    CONST.FICHE.coef = 0.5;
  }else{
    CONST.FICHE.coef = 0.9;
  }
}
coefSize();
CONST.FICHE.width = 0.45*CONST.VUE.WIDTH;
CONST.FICHE.height = CONST.FICHE.coef*CONST.VUE.HEIGHT;  // A ajuster pour la taille de la fiche
